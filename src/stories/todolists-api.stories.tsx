...
export const CreateTodolist = () => {
  ...
  useEffect(() => {
    ...
    todolistApi.createTodolist(todolistTitle).then((res) => setState(res.data.data.item))
  }, [])
...
export const UpdateTodolist = () => {
  ...
  useEffect(() => {
    ...
    todolistApi.updateTodolist(todolistID, todolistTitle).then((res) => setState(res.data))
  }, [])
